...
class PandaClass < Minitest::Test
  def test_panda_name
    ivo = PandaSocialNetwork::Panda.new('Ivo', 'ivo@pandamail.com', 'male')
...
class SocialNetworkClass < Minitest::Test
  def test_add_panda_to_the_network
    network = PandaSocialNetwork::PandaSocialNetwork.new
    ivo = PandaSocialNetwork::Panda.new('Ivo', 'ivo@pandamail.com', 'male')
    rado = PandaSocialNetwork::Panda.new('Rado', 'rado@pandamail.com', 'male')
    tony = PandaSocialNetwork::Panda.new('Tony', 'tony@pandamail.com', 'female')
  ...
  def test__connection_level_2
    ...
    ivo = PandaSocialNetwork::Panda.new('Ivo', 'ivo@pandamail.com', 'male')
    rado = PandaSocialNetwork::Panda.new('Rado', 'rado@pandamail.com', 'male')
    tony = PandaSocialNetwork::Panda.new('Tony', 'tony@gmail.com', 'female')
    network.add_panda(ivo)
    network.add_panda(rado)
    network.add_panda(tony)
  ...
  def test_how_many_gender_in_network
    ...
    rado = PandaSocialNetwork::Panda.new('Rado', 'rado@pandamail.com', 'male')
    tony = PandaSocialNetwork::Panda.new('Tony', 'tony@gmail.com', 'female')
    maria = PandaSocialNetwork::Panda.new('Maria', 'mmm@gmail.com', 'female')
